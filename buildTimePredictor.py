...
def construct_feature_columns():
    bucketized_prefix = tf.feature_column.categorical_column_with_vocabulary_list(
        key="prefix",
        vocabulary_list=["bazelci/", "examples/", "scripts/", "site/", "src/conditions",
                         "src/java_tools", "src/main", "src/test", "src/tools", "third_party/", "tools/"],
        num_oov_buckets=8)
    ...
    prefix_x_type = tf.feature_column.crossed_column(
        set([bucketized_prefix, bucketized_type]), hash_bucket_size=1000)
